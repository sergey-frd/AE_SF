...
function main() 
{
   ...
   // AAAAAAAAAAAAAAAAAAAAAAAAAAAA
    genXml = readXmlaeGenXml("e:\\Git\\P_h_o_t_o\\AE_JSX\\AE_SF\\xml\\gen_System_22_k2.xml");
    ...
    var compFinalName = "aeFinalSFt_22_k2";
    finalComp = handleFinalCompAll(compFinalName);

    var compFinalName = "aeFinalSFt_22_k2_ph_a_bg_1";
    finalComp = handleFinalCompAll_Bg(compFinalName);

    var compFinalName = "aeFinalSFt_22_k2_bg_1";
