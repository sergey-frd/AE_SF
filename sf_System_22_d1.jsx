...
function main() 
{
   ...
   // AAAAAAAAAAAAAAAAAAAAAAAAAAAA
    genXml = readXmlaeGenXml("e:\\Git\\P_h_o_t_o\\AE_JSX\\AE_SF\\xml\\gen_System_22_d1.xml");
    ...
    var compFinalName = "aeFinalSFt_22_d1";
    finalComp = handleFinalCompAll(compFinalName);

    var compFinalName = "aeFinalSFt_22_d1_ph_a_bg_1";
    finalComp = handleFinalCompAll_Bg(compFinalName);

    var compFinalName = "aeFinalSFt_22_d1_bg_1";
