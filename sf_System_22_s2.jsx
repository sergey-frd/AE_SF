...
function main() 
{
   ...
   // AAAAAAAAAAAAAAAAAAAAAAAAAAAA
    genXml = readXmlaeGenXml("e:\\Git\\P_h_o_t_o\\AE_JSX\\AE_SF\\xml\\gen_System_22_s2.xml");
    ...
    var compFinalName = "aeFinalSFt_22_s2";
    finalComp = handleFinalCompAll(compFinalName);

    var compFinalName = "aeFinalSFt_22_s2_ph_a_bg_1";
    finalComp = handleFinalCompAll_Bg(compFinalName);

    var compFinalName = "aeFinalSFt_22_s2_bg_1";
